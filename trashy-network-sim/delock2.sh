...
sudo tc qdisc add dev enx88c9b3beeb6b root netem loss 1% delay 12.5ms 5ms distribution normal
sudo tc qdisc add dev enx88c9b3beeb6c root netem loss 1% delay 12.5ms 5ms distribution normal

sudo tc qdisc add dev enx88c9b3beeb69 root netem loss 1% delay 12.5ms 5ms distribution normal
sudo tc qdisc add dev enx88c9b3beeb6a root netem loss 1% delay 12.5ms 5ms distribution normal
